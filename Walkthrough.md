...
### Step 1:Log into your computer or VPS with SSH (Logging in with SSH is explained [here](Ubuntu_Install.md)
...
:zap: The first option where the page opens on is the quota page. This is where you can lock VITE to get quota.  
:zap: The second option is the voting page. This is where you can select an SBP to vote for.  
:zap: The third option is the Full Node page. This is where you can lock the VITE needed for running a full node. This is the page we are going to choose for locking the 10,000 VITE required for running the full node.  
:zap: The fourth option is the SBP page. This is where you can register an SBP.  
:zap: The fifth option is the Token Issuance page. This is the page to use for minting a new token on the Vite Network.  
:zap: The sixth option is the Transactions page. All transactions done with your logged in wallet will appear here.
